...
const Sidebar = () => {
return (
    <div className="w-sidebar bg-sidebar-bg border-r border-sidebar-border h-full flex flex-col p-lg">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h2 className="text-xl font-semibold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Hackathon</h2>
      </div>

      <div className="bg-background-alt rounded-md p-3 mb-6 flex items-center gap-3 border border-border">
        <div className="w-8 h-8 bg-primary text-white rounded-full flex items-center justify-center text-sm font-semibold">D</div>
        <div className="flex flex-col">
          <span className="text-sm font-medium text-text-primary">Default</span>
          <span className="text-xs text-sidebar-text">Default Org</span>
        </div>
      </div>

      <div className="mb-6">
        <h3 className="text-xs font-semibold text-sidebar-text uppercase tracking-wider mb-3">Overview</h3>
        <NavLink 
          to="/" 
          className={({ isActive }) => 
            `flex items-center gap-3 px-3 py-2 rounded-md transition-colors relative ${
              isActive 
                ? 'bg-sidebar-active text-primary-dark border-r-2 border-primary' 
                : 'text-sidebar-text hover:bg-sidebar-hover hover:text-text-primary'
            }`
          }
        >
          <span className="w-4 h-4 bg-current rounded-sm"></span>
          Extract here !
        </NavLink>
        <NavLink 
          to="/History" 
      ...
      <div className="mb-6">
        <h3 className="text-xs font-semibold text-sidebar-text uppercase tracking-wider mb-3">Tools</h3>
        <NavLink 
          to="/analytics" 
          className={({ isActive }) => 
            `flex items-center gap-3 px-3 py-2 rounded-md transition-colors relative ${
        ...
        >
          <span className="w-4 h-4 bg-current rounded-sm"></span>
          More on your data
          <span className="ml-auto bg-accent text-white text-xs px-2 py-0.5 rounded-full">Beta</span>
        </NavLink>
      </div>
      ...
      <div className="flex items-center gap-3 pt-4 border-t border-border">
        ...
        <div className="flex flex-col">
          <span className="text-sm font-medium text-text-primary">Aaditya S</span>
        </div>
      </div>
    </div>
  );
